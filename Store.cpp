...
void Store::listTransationTimePeriod(Date lowerDate, Date upperDate) const
{
	bool hasTrans = false;
...
{
	out << "Number of clients: " << store.clients.size() << "\n";
	out << "Number of products: " << store.products.size() << "\n";
	out << "Number of transactions: " << store.transactions.size() << "\n"
		<< "\n";
